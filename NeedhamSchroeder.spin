/*** https://homepages.loria.fr/SMerz/papers/NeedhamSchroeder.spin ***/
/*** aussi : https://www.polymtl.ca/crac/LOG3300/NeedhamSchroeder.spin ***/
/*** complete par https://esb-dev.github.io/mat/modelcheck-bsp.pdf ***/
/***
1) on rajoute un monitor à la fin :
$ ./spin -a NeedhamSchroeder.spin
$ /cygdrive/c/mingw64/bin/gcc pan.c
$ ./a -E
pan:1: assertion violated ( !(((statusA==1)&&(statusB==1)))||((partnerA==9)==(partnerB==10))) (at de
pth 41)
...
$ ./spin -t -p NeedhamSchroeder.spin
...
...
#processes: 4
                ...
                knowNB = 1
...
2) on utilise un invariant LTL , et on lance pan avec -a au lieu de -E
...
...
active proctype monitor() {
	assert (!success || (aliceBob == bobAlice)); 
}
***/
